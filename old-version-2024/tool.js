...
const getDecData = (str) => {
    ...
    if (x !== -1) {
        return CryptoJS.enc.Utf8.stringify(
            CryptoJS.enc.Base64.parse(str.slice(0, x).split('').reverse().join('') + '=')
        );
    } else {
...
const toolBase64 = (str) => {
    return CryptoJS.AES.encrypt(CryptoJS.enc.Utf8.parse(str), CryptoJS.enc.Utf8.parse('H0GM7TGBw193GYf8'), {
